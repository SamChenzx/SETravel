...
public struct DebugModels {
    ...
    public static let fontSizeText1 = DevToolModel<CGFloat>("Text", "Font Sizes", "title", 32)
    public static let fontSizeText2 = DevToolModel<CGFloat>("Text", "Font Sizes", "body", 18)
    ...
    public static let horizontalMargins = DevToolModel<CGFloat>("General", "Layout", "H. Margins", defaultValue: 16, min: 0)
    public static let verticalMargins = DevToolModel<CGFloat>("General", "Layout", "V. Margins", defaultValue: 16, min: 0)
    ...
    public static let title = DevToolModel("Text", "Text", "Title", options: ["SwiftTweaks", "Welcome!", "Example"])
    public static let subtitle = DevToolModel<String>("Text", "Text", "Subtitle", "Subtitle")
