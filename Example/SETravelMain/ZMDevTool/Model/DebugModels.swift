...
public struct DebugModels {
    public static let colorBackground = MMDevToolModel("General", "Colors", "Background", Color.orange)
    public static let colorTint = MMDevToolModel("General", "Colors", "Tint", Color.yellow)
    public static let colorButtonText = MMDevToolModel("General", "Colors", "Button Text", Color.purple)

    // Tweaks work *great* with numbers, you just need to tell the compiler
    // what kind of number you're using (Int, CGFloat, or Double)
    public static let fontSizeText1 = MMDevToolModel("Text", "Font Sizes", "title", 32)
    public static let fontSizeText2 = MMDevToolModel("Text", "Font Sizes", "body", 18)
    ...
    public static let horizontalMargins = MMDevToolModel("General", "Layout", "H. Margins", 16, minValue: 0)
    public static let verticalMargins = MMDevToolModel("General", "Layout", "V. Margins", 16, minValue: 0)

    public static let colorText1 = MMDevToolModel("Text", "Color", "text-1", Color.black)
    public static let colorText2 = MMDevToolModel("Text", "Color", "text-2", Color.blue)

    public static let title = MMDevToolModel("Text", "Text", "Title", options: ["SwiftTweaks", "Welcome!", "Example"], defaultValue: "Example")
    public static let subtitle = MMDevToolModel("Text", "Text", "Subtitle", "Subtitle")
...
//    public static let actionPrintToConsole = DevToolModel<ModelAction>("General", "Actions", "Print to console")
    ...
    */
    ...
    public static let featureFlagMainScreenHelperText = MMDevToolModel("Feature Flags", "Main Screen", "Show Body Text", true)
